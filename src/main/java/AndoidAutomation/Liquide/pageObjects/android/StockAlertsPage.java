...
public class StockAlertsPage {
	...
	public WebElement getElementByStockName(String stockName) {
	    String xpath = "//android.view.ViewGroup[contains(@content-desc, '" + stockName + "')]/android.view.ViewGroup/android.widget.TextView[3]";
	    return driver.findElement(By.xpath(xpath));
	}
	
	public void SetStockAlert(String stock,String price) throws InterruptedException
	{
		...
		inputAlertPrice.sendKeys(sPrice);
	    ...
	    Assert.assertEquals(updatedCount, initialCount + 1, "Alert count did not increase!");
